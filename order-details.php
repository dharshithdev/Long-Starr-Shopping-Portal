        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-lg shadow-md p-4 flex flex-col sm:flex-row gap-4 sm:gap-6 items-center">
                ...
                <div class="flex-1 text-center sm:text-left">
                    ...
                    <h2 class="text-xl font-semibold">Order Placed on <?php echo htmlspecialchars($row['creationDate']);?></h2>
                    ...
                    <p class="text-lg mt-1">Quantity: <?php echo $row['quantity']; ?></p>
                    <p class="text-lg mt-1">Payment Mode: <?php echo htmlspecialchars($row['mode']); ?></p>
...
<script src="/longstarr/Scripts/order-details.js"></script>
